  ...
  render() {
    const handleClick = () => {
      window.location.href =
        "https://discord.com/api/oauth2/authorize?client_id=1033867324907864105&redirect_uri=http%3A%2F%2Flocalhost%3A4000%2Fauth%2Fredirect&response_type=code&scope=identify";
      };
    return (
